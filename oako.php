...
<head>
  ...
  <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css">
    <title>expinfo/silver-oak/other-information</title>
</head>
<body>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body popup text-center" >
       ...
       <form action="oakoin.php" method="POST">
           ...
           <div class="form-group">
             <input type="text" class="form-control" name="bname" placeholder="Enter Product Name" required autocomplete="off">
           </div>
           <div class="form-group">
             <input type="text" class="form-control" name="price" placeholder="Enter Product Price" required autocomplete="off">
           </div>
           <div class="modal-footer">
           <small id="emailHelp" class="form-text text-muted">We'll never miss use your information .</small>
            ...
            ?>
                    <tbody>
                        <tr>
                            ...
                            <td class="td-row"> <?php echo $col['pname']; ?> </td>                          
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-12 footer-div text-center">
                <div>
                    <h3>ABOUT EXPINFO</h3>
                    <p>We provide service to sell your products,you just need to enter data.
                        and also provide service to buy products,
                        We also provide Informaion about pg near your college,
                        confession page for each college and events in various college.</p>
                </div>
        ...
        <div class="mt-5 text-center">
            <p>Copyright @2020 All rights reserved | created by  <a href="instagram.com/savaliya__vishal"><i class="fa fa-instagram">savaliya__vishal</i></a></p>
        </div>
    </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <form action="oakoup.php" method="POST">
            ...
            <div class="modal-body ">
                ...
                <div class="form-group">
                    <input type="text" name="bname" id="bname" class="form-control" placeholder="Enter Product Name"  autocomplete="off">
                </div>
                <div class="form-group">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <form action="oakod.php" method="POST">
