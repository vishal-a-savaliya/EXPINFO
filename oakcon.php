...
<head>
  ...
  <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css">
    <title>expinfo/silver-oak/confession</title>
</head>
<body>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body popup text-center" >
       ...
       <form action="oakconin.php" method="POST">
           ...
           <div class="form-group">
             ...
             <small id="emailHelp" class="form-text text-muted">Enter today's Date.</small>
            </div>
           <div class="form-group">
             <textarea type="text" class="form-control" name="mess" placeholder="Enter Confession" required autocomplete="off"></textarea>
           </div>
            ...
            ?>
                    <tbody>
                        <tr>
                            ...
                            <td class="td-row"> <?php echo $col['date']; ?> </td>
                            <td class="td-row"> <?php echo $col['mess']; ?> </td>                                                                                            
                        </tr>
                    </tbody>
            <?php           
                    }
